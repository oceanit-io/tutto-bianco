  ...
  const pilares = [
    {
      icon: (
        <svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M6 2v2m12-2v2" />
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 4h2m14 0h2" />
