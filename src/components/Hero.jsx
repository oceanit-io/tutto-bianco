...
const Hero = () => {
  ...
  const slides = [
    {
      ...
      description: 'Na Tutto Bianco, cada peça recebe atenção especial. Nossa expertise em lavagem profissional garante que suas roupas não apenas fiquem limpas, mas também preservadas, macias e com aquele cheirinho inconfundível de frescor.',
      highlight: 'Qualidade em cada detalhe'
    },
    {
      image: '/img-2.png',
      title: 'Comodidade ao Seu Alcance',
      description: 'Esqueça a correria de levar e buscar roupas na lavanderia. Com nosso serviço de coleta e entrega, você cuida do que realmente importa enquanto nós cuidamos das suas roupas. Simplicidade e praticidade no seu dia a dia.',
      highlight: 'Você em casa, nós cuidamos do resto'
    },
    {
      image: '/img-3.png',
      title: 'Tradição e Modernidade',
      description: 'A Tutto Bianco une a tradição italiana de excelência em cuidados têxteis com tecnologia moderna e processos sustentáveis. Suas roupas merecem o melhor, e é isso que entregamos: resultados impecáveis com responsabilidade ambiental.',
      highlight: 'Excelência italiana em João Pessoa'
    }
  ]
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-white to-primary-100 pt-20 overflow-hidden">
              ...
              {slides.map((slide, index) => (
                ...
                >
                  <div className="grid md:grid-cols-2 gap-8 items-center p-8 md:p-12">
                    ...
                    {/* Texto à Direita */}
                    <div className="order-1 md:order-2 flex flex-col justify-center space-y-6 px-4 md:px-8">
