...
const Hero = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      description: 'Esqueça a correria de levar e buscar roupas na lavanderia. Com nosso serviço de coleta e entrega, você cuida do que realmente importa enquanto nós cuidamos das suas roupas. Simplicidade e praticidade.',
      highlight: 'Você em casa, nós cuidamos do resto'
    },
    {
      image: '/img-3.png',
      title: 'Tradição e Modernidade',
      description: 'A Tutto Bianco une a tradição e a excelência em cuidados têxteis com tecnologia moderna e processos sustentáveis. Suas roupas merecem o melhor, e nós entregamos: resultados impecáveis com responsabilidade',
  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-white to-primary-100 pt-20 overflow-hidden">
